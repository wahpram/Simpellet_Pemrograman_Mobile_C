...
class InsertData : AppCompatActivity() {
    ...
    private fun saveTransactionData() {
        ...
        if(amountEt.isEmpty()){
            ...
            val transaction = Transaksi(transactionID, type, title, category, amount, date, note, invertedDate) //object of data class
            ...
            dbRef.child(transactionID).setValue(transaction)
                .addOnCompleteListener {
                    ...
                    Toast.makeText(this, "Kesalahan ${err.message}", Toast.LENGTH_LONG).show()
                }
