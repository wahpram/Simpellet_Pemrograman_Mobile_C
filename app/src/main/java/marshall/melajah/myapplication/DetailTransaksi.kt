...
import marshall.melajah.myapplication.`object`.Kategori
...
class DetailTransaksi : AppCompatActivity() {
    ...
    private fun deleteData() {
        ...
        deleteData.setOnClickListener {
            alertBox.setTitle("Apakah benar?")
            alertBox.setMessage("Apakah anda ingin menghapus data ini?")
    ...
    private fun deleteRecord(transactionID: String) {
        ...
        if (uid != null) {
            ...
            mTask.addOnSuccessListener {
                Toast.makeText(this, "Data Transaksi Telah Dihapus", Toast.LENGTH_LONG).show()
                finish()
            }.addOnFailureListener { error ->
                Toast.makeText(this, "Error delete ${error.message}", Toast.LENGTH_LONG).show()
            }
        }
    }
    ...
    private fun openUpdateDialog(
        ...
        val listExpense = Kategori.expenseCategory() //getting the arrayList data from CategoryOptions file
        ...
        if (type == 2){ //Income Menu
            ...
            val listIncome = Kategori.incomeCategory()
        ...
        btnUpdateData.setOnClickListener {
            ...
            Toast.makeText(applicationContext, "Data Transaksi Berhasil Diupdate", Toast.LENGTH_LONG).show()
    ...
    private fun updateTransactionData(
        ...
        if (uid != null) {
            ...
            val transactionInfo = Transaksi(transactionID, type, title, category, amount, date, note, invertedDate)
